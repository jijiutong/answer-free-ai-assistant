...
> 一款 Chrome/Edge 浏览器插件，帮助你提取网页题目与学习内容，通过 AI 进行解析、讲解、复盘和导出。
...
### 核心流程
- **内容提取** — 一键提取当前页面学习内容，智能过滤导航、按钮等噪音 DOM
- **文本选择辅助** — 在用户主动开启时改善网页文本选择和复制体验
- **AI 解析** — 将学习内容发送给用户配置的 AI 模型（支持 DeepSeek、OpenAI、本地模型等），返回结构化解析
